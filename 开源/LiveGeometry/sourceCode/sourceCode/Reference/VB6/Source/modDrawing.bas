...
Public BasePoint() As BasePointType
Public Figures() As Figure
Public Locuses() As Locus
Public TextLabels() As TextLabel
Public Macros() As Macro
Public StaticGraphics() As StaticGraphic
Public Buttons() As Button
Public WatchExpressions() As WatchExpression

Public PointCount As Long
Public FigureCount As Long
Public LocusCount As Long
Public LabelCount As Long
Public MacroCount As Long
Public StaticGraphicCount As Long
Public ButtonCount As Long
Public WECount As Long

Public Activity() As Action
Public UndoneActivity() As Action
Public ActivityCount As Long
Public UndoneActivityCount As Long
Public FromRedo As Boolean

Public privNoAlter As Boolean

Public PaperDrawMode As Long
Public PaperDrawStyle As Long
Public PaperDrawWidth As Long
Public PaperScaleWidth As Long
Public PaperScaleHeight As Long
Public OriginX As Long
Public OriginY As Long

'Public FigureNames As New clsSortedCollection
'Public PointNames As New clsSortedCollection
Public LastAllocatedPointName As String
Public LastAllocatedFigureName(dsPoint To dsBisector) As String

Public GivenPoints() As Long
Public GivenFigures() As Long

Public ResultPoints() As Long
Public ResultFigures() As Long
Public ResultSGs() As Long
Public ResultLoci() As Long

Public OrderedPoints() As Long
Public OrderedFigures() As Long

Public TempObjectSelection As ObjectList
Public DemoSequence As LinearObjectList

Public FigureVisualOrder As New Collection
Public CanvasBorders As TwoPoints
Public PaperBorders As RECT
Public WorldTransform As TransformType, DefaultTransform As TransformType
Public WorkArea As TwoPoints
...
Public ColorArray(15) As Long
'Public BackgroundMetafile As Long
Public ServiceHDC As Long
Public ServiceHBitmap As Long
Public OldServiceHBitmap As Long
Public ByteFontName(0 To 31) As Byte 'As String * 32
Public MRUList As New Collection
Public Const LenTempLongStringBuffer = 32760
Public Const LenTempShortStringBuffer = 32
Public TempLongStringBuffer As String * LenTempLongStringBuffer
Public TempShortStringBuffer As String * LenTempShortStringBuffer

Public InDebugMode As Boolean
Public CommandLineFile As String
Public MenuTransposition As Transposition

Public Paper As PictureBox
Public CD As New clsCommonDialog

Public LastFigurePath As String
Public LastMacroPath As String
Public LastPicturePath As String
Public LastHTMLPath As String
Public LastFileLinkPath As String
Public LastSoundPath As String
Public LastTexturePath As String

Public ProgramPath As String
Public HelpPathEnglish As String
Public HelpPathRussian As String
Public HelpPathGerman As String
Public HelpPathUkrainian As String

Public nPaperColor1 As Long
Public nPaperColor2 As Long
Public nAxesColor As Long
Public nGridColor As Long
Public nGradientPaper As Boolean
Public nShowAxes As Boolean
Public nShowGrid As Boolean
Public nDescription As String
Public nActiveAxesAdded As Boolean
Public nActiveX As Long
Public nActiveY As Long
Public nDemoInterval As Long

Public DrawingState As Long
Public DrawingName As String
Public ActiveFigure As Long
Public ActivePoint As Long
Public ActiveLabel As Long
Public ActiveStatic As Long
Public ActiveButton As Long
Public ManualDragFlag As Long
Public ProgressMsg As String
Public ProgressQuiet As Boolean
Public ToolTipShown As Boolean
Public CurrentToolTipText As String
'Public MenuHandle As Long
Public WindowStyle As Long
Public FontList As New clsSortedCollection

Public Sensitivity As Double
'Public ParDist As Double
Public AngleMarkDist As Double
Public DefaultFontCharset As Integer

Public curArrow As StdPicture
Public curArrowPlus As StdPicture
Public curArrowMinus As StdPicture
Public curArrowCross As StdPicture
Public curArrowDrag As StdPicture
Public curArrowSelect As StdPicture

Public setPaperCursorArrow As Integer
Public setPaperCursorCross As Integer
Public setPaperCursorDrag As Integer

'=========================================================
'Miscellaneous auxiliary variable declarations
'=========================================================

Public Pts() As POINTAPI
Public PtNums() As Long
Public UBoundPtNums As Long

'Public TempFontDC As Long
'Public TempFontHandle As Long

'=========================================================
'=========================================================
'=========================================================

Public Sub InitDrawing(Optional ByVal ShouldRefresh As Boolean = False, Optional ByVal ShouldClearUndo As Boolean = True, Optional ByVal ShouldTryToAddAxes As Boolean = True)
Dim Z As Long

If ShouldClearUndo Then
    ClearUndoBuffer
    ClearRedoBuffer
End If

Do While FigureVisualOrder.Count <> 0
    FigureVisualOrder.Remove 1
Loop
'FigureNames.Clear
'PointNames.Clear
LastAllocatedPointName = ""
For Z = dsPoint To dsBisector
    LastAllocatedFigureName(Z) = ""
Next
...
ReDim TextLabels(1 To 1)
ReDim StaticGraphics(1 To 1)
ReDim Buttons(1 To 1)
LocusCount = 0
FigureCount = 0
PointCount = 0
LabelCount = 0
StaticGraphicCount = 0
ButtonCount = 0
...
nDescription = ""
nActiveAxesAdded = False
nDemoInterval = defDemoInterval

LoadIdentity
FormMain.mnuActiveAxes.Enabled = True
nActiveAxesAdded = False
nActiveX = -1
nActiveY = -1
If nShowAxes And ShouldTryToAddAxes Then AddActiveAxes

IsDirty = False

If ShouldRefresh Then
    If Paper.BackColor <> nPaperColor1 Then Paper.BackColor = nPaperColor1
    PaperCls
    ShowAll
End If
End Sub
...
Dim ShouldDeleteX As Boolean, ShouldDeleteY As Boolean
...
If nActiveX = Index Then ShouldDeleteY = True
If nActiveY = Index Then ShouldDeleteX = True
...
If FigureCount > 0 Then
    ...
    Next Z
    RedimPreserveFigures 0, FigureCount - 1
End If
...
If nActiveX > Index Then nActiveX = nActiveX - 1
If nActiveY > Index Then nActiveY = nActiveY - 1

If ShouldDeleteY Then
    nActiveX = -1
    If nActiveY >= 0 And nActiveY <= FigureCount Then DeleteFigure nActiveY, False, True
End If
If ShouldDeleteX Then
    nActiveY = -1
    If nActiveX >= 0 And nActiveX <= FigureCount Then DeleteFigure nActiveX, False, True
End If
WereActiveAxesAdded
...
If PointCount > 0 Then
    If Index < PointCount Then
        ...
        Next Z
    End If
    If PointCount > 1 Then RedimPreserveBasePoint 1, PointCount - 1
End If
...
Public Function IsFigureAnalytic(ByVal Figure1 As Long) As Boolean
    IsFigureAnalytic = IsLineAnalytic(Figure1) Or IsCircleAnalytic(Figure1)
End Function

Public Function IsLineAnalytic(ByVal Figure1 As Long) As Boolean
...
Public Function IsCircleAnalytic(ByVal Figure1 As Long) As Boolean
If Figure1 < FigureCount And Figure1 >= 0 Then
...
AddChildrenRecord Figures(Figure1), NewFigure
