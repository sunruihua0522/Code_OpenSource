...
namespace System.Collections.ObjectModel
{
    ...
    [Serializable]
#endif
    public class ObservableCollectionEx2<T> : Collection<T>, INotifyCollectionChanged, INotifyPropertyChanged,
                                             IDisposable
    {
        //-----------------------------------------------------
        //  Constants
        ...
        /// <summary> 
        /// Initializes a new instance of ObservableCollectionEx2 that is empty and has default initial capacity. 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the ObservableCollectionEx2 class
        /// that contains elements copied from the specified list 
        /// </summary>
        /// <param name="list">The list whose elements are copied to the new list.</param> 
        /// <remarks> 
        /// The elements are copied onto the ObservableCollectionEx2 in the
        /// same order they are read by the enumerator of the list. 
        /// </remarks>
        /// <exception cref="ArgumentNullException"> list is a null reference </exception>
        public ObservableCollectionEx2(List<T> list)
        ...
        public ObservableCollectionEx2(IEnumerable<T> collection)
        {
            if (collection == null)
        ...
        /// <summary>
        /// Returns an instance of ObservableCollectionEx2
        ...
        /// </summary>
        /// <returns>ObservableCollectionEx2</returns>
        public ObservableCollectionEx2<T> DelayNotifications()
        {
            return new ObservableCollectionEx2<T>((null == _notifyInfo) ? this : _notifyInfo.RootCollection, true);
        }

        /// <summary>
        /// Returns a wrapper instance of an ObservableCollectionEx2 class.
        /// Calling methods of this instance will modify original collection
        /// but will not generate any notifications.
        /// </summary>
        /// <returns>ObservableCollectionEx2</returns>
        public ObservableCollectionEx2<T> DisableNotifications()
        {
            return new ObservableCollectionEx2<T>((null == _notifyInfo) ? this : _notifyInfo.RootCollection, false);
        }
        ...
        protected void CheckReentrancy()
        {
            ...
            {
                throw new InvalidOperationException("ObservableCollectionEx2 Reentrancy Not Allowed");
            }
        }
        ...
        private class NotificationInfo
        {
            ...
            public ObservableCollectionEx2<T> RootCollection { get; set; }
